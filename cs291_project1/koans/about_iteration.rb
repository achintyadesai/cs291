...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject() defines a block of code within {} that will be executed over every element on which inject was called on.(In above case, it is 2,3 and 4). The first argument inside the block is assigned the value provided to inject function. It is similar to initializing a variable before the loop execution. Second argument inside the block is the one that iterates oveer the value
  end
