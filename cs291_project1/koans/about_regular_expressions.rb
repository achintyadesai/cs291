...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # Always returns first occurrence where the pattern matches. There could be more than one
  ...
  # character class matches only one character whereas alteration can match more than one
